...
namespace game
{
    ...
    {
        loadTexture("assets/tiles/tile_b_light.png", generateTextureKey(Components::EVEN_TILE, entity::Color::NONE));
        loadTexture("assets/tiles/tile_b_dark.png", generateTextureKey(Components::ODD_TILE, entity::Color::NONE));
    ...
    void Board::displayHighlightedTiles() const
    {
        ...
        highlightShape.setFillColor(sf::Color(60, 45, 100, 100));
